 ...
 * [ 明细构建 ]
 */
APP.controller('buildDetailCtrl', [
  '$rootScope',
  '$scope',
  '$timeout',
  '$loading',
  ...
  'buildDetailConstant',
  'positionConstant',
  ($rootScope, $scope, $timeout, $loading, $log, $appHttp, localStorageService, userInfo, templateMainType,buildDetailConstant,positionConstant) => {
